      ...
      <div className="glass rounded-3xl p-10 md:p-14 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 glass glass-hover text-white font-semibold py-3 px-6 rounded-xl font-display transition-all hover:text-[var(--blue-300)] hover:-translate-y-1"
          >
          ...
          {/* LinkedIn Button (GANTI LINK INI) */}
          <a
            href="https://linkedin.com/in/rochwidias"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 glass glass-hover text-white font-semibold py-3 px-6 rounded-xl font-display transition-all hover:text-[var(--blue-300)] hover:-translate-y-1"
          >
          ...
          {/* Instagram Button (GANTI LINK INI) */}
          <a
            href="https://instagram.com/projectrennsh"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 glass glass-hover text-white font-semibold py-3 px-6 rounded-xl font-display transition-all hover:text-[var(--blue-300)] hover:-translate-y-1"
          >
